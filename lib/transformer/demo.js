...
module.exports = function(doc) {
  ...
  $Demo.forEach(function(el) {
    ...
    var isDeffered = iframe.getAttribute('data-deferred') !== null;
    var defferedAttr = isDeffered ? 'data-livecode-deferred' : '';
    ...
    demo.innerHTML = util.format(template, defferedAttr, title, iframeSrc, content);
